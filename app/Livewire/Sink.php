...
class Sink extends Component implements HasForms, HasActions
{
    ...
    {
        $this->form->fill([
            'default' => '<p></p><h2>Praesentium Consequuntur Qui Repudiandae Quo Deserunt Sed</h2><p>Provident <a href="https://filamentphp.com">architecto et recusandae</a> nulla et sint voluptate. Est vero nisi nulla libero. Dolor <a href="https://google.com">necessitatibus consequuntur</a> occaecati quae porro sed quisquam. Deleniti occaecati tenetur quisquam et odio necessitatibus. Blanditiis ut quia perspiciatis.</p><pre class="hljs"><code>export default function testComponent({
    state,
}) {
    return {
        state,
