...
class TestPage extends Page
{
    ...
    protected function getFormSchema(): array
    {
        return [
            ...
            TiptapEditor::make('simple')->profile('simple'),
            TiptapEditor::make('barebone')->profile('barebone')->extraInputAttributes(['style' => 'min-height: 12rem;']),
        ];
    }
